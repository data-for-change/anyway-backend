...
Revision ID: 8d711a68e7b5
Revises: 
Create Date: 2019-12-06 10:28:33.380539
...
def upgrade():
    op.create_table(
        ...
        sa.Column('yuishuv_shape', sa.Integer(), nullable=True),
        sa.Column('yuishuv_shape_hebrew', sa.Text(), nullable=True),
